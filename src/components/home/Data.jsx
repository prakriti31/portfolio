...
const Data = () => {
    return (
        <div className = "home__data">
            ...
            <p className = "home__description">I am a Software Developer based in Chicago, United States. I am pursuing
            ...
            with a Fintech Company @Cashfree Payments. Please find my relevant experience below.</p>
